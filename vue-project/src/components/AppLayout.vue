...
const navItems = [
  { label: 'Mi deuda',       path: '/usuario'    },
  { label: 'Simulador',      path: '/simulador'  },
  { label: 'Mi solicitud',   path: '/solicitud'  },
...
<template>
  <div class="app-shell">
    ...
    <header class="app-header">
      ...
      <span class="brand">Oficina Virtual FSCU</span>

      <div class="header-right">
        <div class="user-info">
          <span class="name">{{ auth.nombre }}</span>
          <span class="divider-dot">—</span>
          <span class="rut">{{ auth.rut }}</span>
        </div>
...
.user-info .rut  { color: var(--text-muted); font-family: 'DM Mono', monospace; font-size: 12px; }
...
@media (max-width: 600px) {
  ...
  .user-info .rut  { display: none; }
  .divider-dot     { display: none; }
  .logout-btn span { display: none; }  /* solo icono en móvil */
